...
Ffan Front End Open Platform.

Based and inspired on [React Redux Starter Kit](https://github.com/davezuko/react-redux-starter-kit#application-structure)

### Install from source

```bash
$ git clone git@10.77.144.192:web-fe/colosseum.git
```
