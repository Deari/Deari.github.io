    ...
    return (
      <div className="container clx">
        <div className='sidebar'>
          <a className="create-btn" onClick={this.clickBtn.bind(this, 'create')}><i className="iconfont icon-create"></i>发布新组件</a>
          <ul className="help-menu">
            <li><a onClick={this.clickBtn.bind(this, 'list')}><i className="iconfont icon-application"></i>我的组件</a></li>
