        ...
        <div>
          <div className='form-row code-desc'>
            ...
            <div className='row-right'>
              <textarea maxLength={totalCount} placeholder='请输入版本介绍。此内容将显示在组件详情页的版本信息中。' value={codeDesc ? codeDesc : ''} onChange={this.onChangeDesc.bind(this)} onBlur={this.onChangeDesc.bind(this)} />
