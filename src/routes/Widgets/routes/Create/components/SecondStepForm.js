        ...
        <div>
          <div className='form-row code-desc'>
            ...
            <div className='row-right'>
              ...
              <textarea maxLength={totalCount} placeholder='请输入版本介绍。此内容将显示在组件详情页的版本信息中。' onChange={this.onChangeDesc.bind(this)} onBlur={this.onChangeDesc.bind(this)} />
          ...
          <div className='form-row form-rowM'>
            ...
            <div className='row-right'>
              <div className='row-radio'>
                ...
                <span>
                  <i className='iconfont icon-radio1 icon-publish' />
                  <i className='iconfont icon-radio icon-publish' />
                </span>
              </div>
