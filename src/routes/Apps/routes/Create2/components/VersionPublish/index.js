      	...
      	<div className="item-wrapper">
      		...
      		<div className={s['apply-radio']}>
      			<div className="row-radio">
					    <input type="radio" name="radio" id="hand" value="" className="input-radio"/>
							<span className="radio-item">
							    <i className="iconfont icon-radio1"></i>
							    <i className="iconfont icon-radio"></i>
							</span>
						</div>
						<label htmlFor="hand" className={s['text-con']}>手动发布此版本</label>
					</div>
					<div className={s['apply-radio']}>
						<div className="row-radio">
					    <input type="radio" name="radio" id="automatic" value="" className="input-radio" />
							<span className="radio-item">
							    <i className="iconfont icon-radio1"></i>
							    <i className="iconfont icon-radio"></i>
							</span>
						</div>
						<label htmlFor="automatic" className={s['text-con']}>自动发布此版本</label>
      		</div>
      	</div>
      </div>
    </div>
