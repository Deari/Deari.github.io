          ...
          <div key={index} className='list-container'>
            ...
            <div className='info-content w332'>
              <Link className='info-name' title={item.name} to={item.detailUrl}>
                <span>{item.name}</span>
                { item.latestCodeVersion && <i className={item.appKind === 0 ? 'icon-rnpng' : item.appKind === 1 ? 'icon-hpng' : 'icon-apkpng'} /> }
              </Link>
            ...
            <div className='w190'>
              { item.latestCodeVersion && <div className='info-status'>
                <span className='info-status-info1'>
                  <i className={item.latestActiveColor} />{item.latestCodeVersion}
                </span>
              ...
              { item.prevCodeVersion && <div className='info-status'>
                <span className='info-status-info1'>
                  <i className={item.prevActiveColor} />{item.prevCodeVersion}
                </span>
